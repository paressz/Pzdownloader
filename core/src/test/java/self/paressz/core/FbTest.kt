...
class FbTest {
    ...
    fun fbDonwloadTest() {
        ...
        val data = listOf(FbResponse.DataItem(thumbnail = thumbnailUrl, resolution = "720", url = hdUrl, shouldRender = false))
        val mockResponse = FbResponse(status = true, data = data)
